...
try {
    ...
    // For assignment demo, we won't fail the flow if email can’t send.
    // You can echo the error if the tutor wants to see it:
    // echo "Mailer Error: {$mail->ErrorInfo}";
    // Optional: show OTP on-screen as fallback for demo:
    // echo "<p>(Demo fallback) Your code is: {$code}</p>";
}
